...
Define the single command declaration table behind CLI help and argument parsing: per-command help, positional component selection, per-command option declaration, and the unknown-option policy.
