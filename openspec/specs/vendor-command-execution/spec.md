# Vendor Command Execution Specification

## Purpose

Define the command-side planning, preparation, execution, and contribution contracts shared by vendor-backed compile, test, and preview commands.
