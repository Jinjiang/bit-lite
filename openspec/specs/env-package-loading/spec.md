...
Define env package resolution, fixed local materialization, JSON loading, inheritance, structured identity, origin-aware specifiers, and actionable failures.
