...
Define how a pending release is presented for review before anything is written — the components it covers and why, the per-component version decision the user makes, the consequences of including or excluding a component, and the guarantee that reviewing and abandoning a release leaves the store untouched.
